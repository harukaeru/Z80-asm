 ...
 *           and implemented memwrt function for 8080 to support ROM
 */
...
/*
 *	Implementation of memory write for CPU
 *      If rom_start > 0 memory up from this address is R/O
 */
